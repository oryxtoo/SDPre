...
public class AgeMessages{
	public static void main(String[] args) {
		...
		//When entering an age greater than 65, it prints all of
		//the messages, since the age is older than the limits.
		
		//Added code to check for 65 and print "old enough to retire".
		if (age >= 65) {
