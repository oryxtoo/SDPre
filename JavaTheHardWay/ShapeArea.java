...
public class ShapeArea {
	public static void main(String [] args) {
		...
		do {
			...
			System.out.println("4) Square"); //added square to menu
		...
		if (choice == 1) {
			...
			System.out.print("\nWidth: ");
			int w = keyboard.nextInt();
			System.out.println("The area is " + computeSquareArea(h, w));
			//added code to calculate area of a square.
		}
		else if (choice != 5) {
	...
	public static int computeSquareArea(int height, int width) {
		int A;
		A = height * width;
		return A;
	}
